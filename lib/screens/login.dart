...
import 'package:tinder_app/screens/register.dart';
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              ...
                              customTextField("Password", TextInputType.text, passwordcontroller, obsecureText,IconButton(
                                  onPressed: (){
                                    setState(() {
                              ...
                              Padding(
                                ...
                                child: FlatButton(
                                  ...
                                  onPressed: (){
                                    ...
                                    firebaseHelper().Login(emailcontroller.text,passwordcontroller.text);
logIn();
                                  },
